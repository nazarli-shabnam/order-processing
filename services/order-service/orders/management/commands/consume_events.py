...
Run this command to start the Order Service event consumer.
...
from orders.event_handlers import route_event
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Starting Order Service event consumer...'))
